...
export default function SMLayout() {
    ...
    useEffect(() => {
        ...
        setAuthorized(!!payload && payload.role === "sales_manager");
        setChecking(false);
    }, []);
            ...
            <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4">
                <div className="bg-white border border-gray-200 rounded-xl p-10 text-center max-w-sm w-full">
                    ...
                    <p className="text-sm text-gray-500 mb-6">
                        This area is restricted to sales managers only.
                    </p>
                    <button
        ...
        <div className="min-h-screen bg-gray-100 flex">
            <aside className="w-56 shrink-0 bg-white border-r border-gray-200 flex flex-col">
                <div className="px-5 py-5 border-b border-gray-100">
                    <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-0.5">MyStore</p>
                    <h2 className="text-base font-bold text-gray-900">Sales Panel</h2>
                </div>
